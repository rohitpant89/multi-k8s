...
kubectl set image deployments/client-deployment client=rohitpan89/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=rohitpan89/multi-worker:$SHA
